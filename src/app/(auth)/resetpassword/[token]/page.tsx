...
const initialState = { success: false, message: "", error: null } as {
  success: boolean;
  message: string | null;
  error: string | null;
};
...
const ConfirmNewPassword = () => {
  ...
  return (
    <>
      ...
      <h1 className="text-white font-[family-name:var(--font-poiret-one)] ">
        Update your password and continue exploring our app.
      </h1>
