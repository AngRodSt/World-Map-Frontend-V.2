...
const Note = ({ note }: { note: NoteProps }) => {
  ...
  return (
    <>
      <div
        data-aos="fade-up"
        className=" bg-gray-200 rounded-lg  overflow-hidden transition ease-in-out"
        style={{
          boxShadow:
            ...
            <div className=" pb-20">
              ...
              <div className="absolute bottom-3 gap-3 flex flex-row w-full z-10">
                <button
                  ...
                  className=" shadow-lg bg-gray-900 p-1 mx-2 w-1/2 rounded-md text-white hover:bg-black hover:scale-105 transition-transform ease-in-out"
                >
                  Edit
                </button>
                <button
                  onClick={() => setConfirmIsOpen(true)}
                  className=" shadow-lg bg-amber-400 p-1 mx-2 w-1/2 rounded-md  hover:bg-amber-500 hover:scale-105 transition-transform ease-in-out"
                >
                  Delete
                </button>
              </div>
