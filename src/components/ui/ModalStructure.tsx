...
const ModalStructure: React.FC<ModalStructureProps> = ({
  ...
  const CenterMap: React.FC<{
    selectedCountry: Feature<Polygon | MultiPolygon>;
  }> = ({ selectedCountry }) => {
    const map = useMap();
    useEffect(() => {
      if (selectedCountry) {
            ...
            <div className="[direction:ltr] flex md:flex-row flex-col gap-5 px-4 w-auto justify-center items-center ">
              <div className="sm:w-1/2 w-full">
                ...
                >
                  ...
                  {selectedContry.geometry.type === "Polygon" ||
                  selectedContry.geometry.type === "MultiPolygon" ? (
                    <CenterMap
                      selectedCountry={
                        selectedContry as Feature<Polygon | MultiPolygon>
                      }
                    />
                  ) : null}
                </MapContainer>
              ...
              <div className="w-1/2 flex flex-col items-center justify-center ">
                ...
                <div className="button-wrapper mt-5 flex flex-col md:flex-row">
                  <button
                    className="reject cookie-button w-full md:w-1/2 "
                    onClick={() => {
                      onDelete();
                      setAlert({
                  ...
                  <button
                    className="accept cookie-button w-full md:w-1/2"
                    onClick={() => {
