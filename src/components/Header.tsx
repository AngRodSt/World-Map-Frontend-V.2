...
const Header = () => {
  ...
  const [avatar, setAvatar] = useState<{ data: string, contentType: string } | FileList>()
    ...
    <>
      <div className="  font-[family-name:var(--font-poiret-one)] relative  mx-10  py-5  sm:flex-row flex flex-col justify-between items-center">
        ...
        <div className="poiret-one-regular mb-3 ">
          <Link href='/worldsxmap/admin'> <h1 className="shadow-text-black font-extrabold text-2xl">World<span className="text-amber-500">sx</span>Map </h1>
          </Link>
        </div>
